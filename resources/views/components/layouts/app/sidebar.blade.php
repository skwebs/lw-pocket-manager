...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
	...
	<body class="bg-white dark:bg-zinc-800 min-h-screen">
		<flux:sidebar sticky stashable class="border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 border-e">
						...
						<div class="p-0 text-sm font-normal">
							<div class="flex items-center gap-2 px-1 py-1.5 text-start text-sm">
								<span class="relative flex h-8 w-8 shrink-0 overflow-hidden rounded-lg">
									<span class="bg-neutral-200 text-black dark:bg-neutral-700 dark:text-white flex h-full w-full items-center justify-center rounded-lg">
										{{ auth()->user()->initials() }}
									</span>
								</span>
